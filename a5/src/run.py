...
if args.function == 'pretrain':
    ...
    finetune_text = open(args.finetune_corpus_path, encoding='utf-8').read() #finetune_dataset = dataset.CharCorruptionDataset(finetune_text, block_size)
    finetune_dataset = dataset.NameDataset(pretrain_dataset, finetune_text)
    if args.reading_params_path: #pretrained model
